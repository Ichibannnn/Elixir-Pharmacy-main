      ...
      <Flex mb={2} justifyContent="space-between">
        ...
        <HStack>
          <Badge colorScheme="green">
            <Text color="secondary">Number of Records: {cancelledData.cancel?.length}</Text>
          </Badge>
        </HStack>
      </Flex>
          ...
          <Table variant="striped" size="sm">
            ...
            <Tbody>
              {cancelledData.cancel?.map((c, i) => (
                <Tr key={i}>
                  {/* <Td>{c.id}</Td> */}
                  <Td>{c.ymir_PO_Number === null ? c.pO_Number : c.ymir_PO_Number}</Td>
                  <Td>{c.itemCode}</Td>
                  ...
                  <Td>{c.remarks}</Td>
                  <Td>
                    <Button onClick={() => returnRMHandler(c.id)} color="white" bgColor="danger" _hover={{ bgColor: "secondary", color: "white" }} size="xs">
                      Return
                    </Button>
                  </Td>
                </Tr>
