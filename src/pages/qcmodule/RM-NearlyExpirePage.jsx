  ...
  return (
    <Flex p={5} w="full" flexDirection="column">
      <Flex justifyContent="center">
        <Heading color="secondary" fontSize="xl" justifyContent="center">
          Nearly Expired Raw Materials
        </Heading>
      </Flex>
      ...
      <Flex mb={2} justifyContent="space-between">
        <HStack>
          <InputGroup>
            ...
            <Input onChange={(e) => searchHandler(e.target.value)} type="text" placeholder="Search: PO Number" focusBorderColor="accent" />
          </InputGroup>
        </HStack>
        <HStack>
          <Badge colorScheme="green">
            <Text color="secondary">Number of Records: {nearlyExpireData.expiry?.length}</Text>
          </Badge>
        </HStack>
      </Flex>
          ...
          <Table variant="striped" size="sm">
            ...
            <Tbody>
              {nearlyExpireData.expiry?.map((ne, i) => (
                <Tr key={i}>
                  <Td>{ne.ymir_PO_Number === null ? ne.pO_Number : ne.ymir_PO_Number}</Td>
                  <Td>{ne.itemCode}</Td>
                  ...
                  <Td>
                    <Button onClick={() => viewHandler(ne.receivingId)} color="white" colorScheme="green" _hover={{ bgColor: "secondary", color: "white" }} size="xs">
                      View
                    </Button>
                  </Td>

                  <Td>
                    <Button onClick={() => approveHandler(ne.receivingId)} color="white" bgColor="#3C8DBC" _hover={{ bgColor: "secondary", color: "white" }} size="xs">
                      Approve
                    </Button>
                  </Td>

                  <Td>
                    <Button onClick={() => rejectHandler(ne.receivingId)} color="white" bgColor="danger" _hover={{ bgColor: "secondary", color: "white" }} size="xs">
                      Reject
                    </Button>
                  </Td>
                </Tr>
      ...
      {isView && <ViewModal isOpen={isView} onClose={closeView} receivingId={receivingId} />}
