  ...
  return (
    <Flex p={5} w="full" flexDirection="column">
      ...
      <Flex mb={2} justifyContent="space-between">
        ...
        <HStack>
          <Badge colorScheme="green">
            <Text color="secondary">Number of Records: {poData.posummary?.length}</Text>
          </Badge>
        </HStack>
      </Flex>
                  ...
                  <Tr key={po.id}>
                    ...
                    <Td>
                      <HStack spacing={4}>
                        ...
                        <Button onClick={() => editModalHandler(po)} color="white" bgColor="#3C8DBC" _hover={{ bgColor: "secondary", color: "white" }} size="xs">
                          Edit
                        </Button>

                        <Button onClick={() => cancelModalHandler(po.id)} color="white" bgColor="danger" _hover={{ bgColor: "secondary", color: "white" }} size="xs">
                          Cancel
                        </Button>
                      </HStack>
                    </Td>
      ...
      <Flex justifyContent="end" mt={5}>
        {isViewModalOpen && <ViewModalComponent isOpen={isViewModalOpen} onClose={closeViewModal} viewingData={viewingData} />}

        {isEditModalOpen && <EditModalComponent isOpen={isEditModalOpen} onClose={closeEditModal} editData={editData} fetchPo={fetchPo} fetchNotification={fetchNotification} />}

        {isCancelModalOpen && <CancelModalComponent isOpen={isCancelModalOpen} onClose={closeCancelModal} poId={poId} fetchPo={fetchPo} fetchNotification={fetchNotification} />}
