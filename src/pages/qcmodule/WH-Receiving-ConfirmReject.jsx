...
import { Badge, Button, Flex, Heading, HStack, Input, InputGroup, InputLeftElement, Select, Skeleton, Stack, Table, Tbody, Td, Text, Th, Thead, Tr } from "@chakra-ui/react";
...
const WHConfirmReject = ({ fetchNotification }) => {
  ...
  return (
    <Flex p={5} w="full" flexDirection="column">
      ...
      <Flex mb={2} justifyContent="space-between">
        ...
        <HStack>
          <Badge colorScheme="green">
            <Text color="secondary">Number of Records: {rejectedMaterialsData?.reject?.length}</Text>
          </Badge>
        </HStack>
      </Flex>
            ...
            <Tbody>
              {rejectedMaterialsData?.reject?.map((rmd) => (
                <Tr key={rmd.id}>
                  ...
                  <Td>
                    <Button onClick={() => viewingHandler(rmd, rmd.id)} color="white" colorScheme="blue" _hover={{ bgColor: "secondary", color: "white" }} size="xs">
                      View
                    </Button>
                  </Td>
                </Tr>
      ...
      {isViewingModalOpen && <ViewingModal viewingId={viewingId} viewingData={viewingData} isOpen={openViewingModal} onClose={closeViewingModal} />}
