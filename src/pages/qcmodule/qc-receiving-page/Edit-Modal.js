...
import { Flex, Input, Text, Stack, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, ModalFooter, FormLabel, useToast, VStack } from "@chakra-ui/react";
...
export const EditModalComponent = ({ editData, isOpen, onClose, fetchPo, fetchNotification }) => {
  ...
  const { register, watch } = useForm({
    ...
    defaultValues: {
      ...
      displayData: {
        id: editData.id,
        pR_Number: editData?.ymir_PR_Number === null ? editData.pR_Number : editData?.ymir_PR_Number,
        pR_Date: moment(editData.pR_Date).format("MM/DD/YYYY"),
        pO_Number: editData?.ymir_PO_Number === null ? editData.pO_Number : editData?.ymir_PO_Number,
  ...
  // console.log("displayData", watch("displayData"));
              ...
              <PageScrollQCModal>
                <Stack spacing={5}>
                  ...
                  <Flex justifyContent="space-between">
                    <FormLabel w="40%">
                      Item Code
                      <Input {...register("displayData.itemCode")} readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
                    </FormLabel>

                    <FormLabel w="40%">
                      Description
                      <Input {...register("displayData.itemDescription")} readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
                    </FormLabel>
                  </Flex>
                  ...
                  <Flex justifyContent="space-between">
                    <FormLabel w="40%">
                      Supplier
                      <Input {...register("displayData.supplier")} readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
                    </FormLabel>
                  ...
                  <Flex justifyContent="space-between">
                    <FormLabel w="40%">
                      PO NO.
                      <Input {...register("displayData.pO_Number")} readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
                    </FormLabel>

                    <FormLabel w="40%">
                      PO Date
                      <Input {...register("displayData.pO_Date")} readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
                    </FormLabel>
                  </Flex>
                  ...
                  <Flex justifyContent="space-between">
                    <FormLabel w="40%">
                      PR NO.
                      <Input {...register("displayData.pR_Number")} readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
                    </FormLabel>

                    <FormLabel w="40%">
                      PR Date
                      <Input {...register("displayData.pR_Date")} readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
                    </FormLabel>
                  </Flex>
                  ...
                  <Flex justifyContent="space-between">
                    <FormLabel w="40%">
                      Quantity Ordered
                      <Input {...register("displayData.quantityOrdered")} readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
                    </FormLabel>

                    <FormLabel w="40%">
                      UOM
                      <Input {...register("displayData.uom")} readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
                    </FormLabel>
                  </Flex>

                  <Flex justifyContent="space-between">
                    <VStack spacing={-1.5} w="40%">
                      <FormLabel w="96%">Manufacturing Date</FormLabel>
                      <Input onChange={(date) => manufacturingDateProvider(date.target.value)} max={maxDateManufacturing} type="date" bgColor="#fff8dc" />
                    </VStack>

                    <VStack spacing={-1.5} w="40%" mr={3}>
                      <FormLabel w="96%">Expiry Date</FormLabel>
                      <Input onChange={(date) => expiryDateProvider(date.target.value)} min={minDateExpiry} type="date" bgColor="#fff8dc" />
                    </VStack>
                  </Flex>
                  ...
                  <Flex justifyContent="space-between">
                    <FormLabel w="40%">
                      ...
                      <Input {...register("displayData.actualRemaining")} readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
                    </FormLabel>
                ...
                <Text fontWeight="hairline" textAlign="center">
                  Upon arrival of the vehicle of medication/material at unloading area inspect the following:
                </Text>
