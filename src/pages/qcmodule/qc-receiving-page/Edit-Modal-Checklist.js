...
import { Flex, HStack, Input, Text, Stack, Box, Radio, VStack } from "@chakra-ui/react";
      ...
      <Box>
        ...
        <Flex justifyContent="space-between" mt={2}>
          ...
          <HStack mr={2}>
            ...
            <Input placeholder="Optional" onChange={(e) => truckInspection1Remarks(e.target.value)} />
          </HStack>
        </Flex>
        ...
        <Flex justifyContent="space-between" mt={2}>
          ...
          <HStack mr={2}>
            ...
            <Input onChange={(e) => truckInspection2Remarks(e.target.value)} placeholder="Optional" />
          </HStack>
        </Flex>
        ...
        <Flex justifyContent="space-between" mt={2}>
          ...
          <HStack mr={2}>
            ...
            <Input onChange={(e) => truckInspection3Remarks(e.target.value)} placeholder="Optional" />
          </HStack>
        </Flex>
        ...
        <Flex justifyContent="space-between" mt={2}>
          ...
          <HStack mr={2}>
            ...
            <Input onChange={(e) => truckInspection4Remarks(e.target.value)} placeholder="Optional" />
          </HStack>
        </Flex>
      ...
      <Box>
        ...
        <Flex justifyContent="space-between" mt={2}>
          ...
          <HStack mr={2}>
            ...
            <Input onChange={(e) => checkingPA1Remarks(e.target.value)} placeholder="Optional" />
          </HStack>
        </Flex>
        ...
        <Flex justifyContent="space-between" mt={2}>
          ...
          <HStack mr={2}>
            ...
            <Input onChange={(e) => checkingPA2Remarks(e.target.value)} placeholder="Optional" />
          </HStack>
        </Flex>
      ...
      <Box>
        ...
        <Flex justifyContent="space-between" mt={2}>
          ...
          <HStack mr={2}>
            ...
            <Input onChange={(e) => checklistQARemarks(e.target.value)} placeholder="Optional" />
          </HStack>
        </Flex>
      </Box>
    </Stack>
