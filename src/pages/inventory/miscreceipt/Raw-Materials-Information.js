      ...
      <VStack w="full" spacing={6}>
        ...
        <Flex w="full" justifyContent="space-between">
          <VStack alignItems="start" w="40%" mx={5}>
            ...
            <HStack w="full">
              ...
              {suppliers.length > 0 ? (
                <Select onChange={(e) => supplierHandler(e.target.value)} ref={supplierRef} w="full" bgColor="#fff8dc">
                  {suppliers?.map((item, i) => (
                    <option
                      key={i}
                      defaultValue={supplierData?.supplierCode - supplierData?.supplierName}
          ...
          <VStack alignItems="start" w="40%" mx={5}>
            ...
            <HStack w="full">
              ...
              <Text bgColor="gray.200" w="full" border="1px" borderColor="gray.200" py={1.5}>
                {supplierData.supplierName ? supplierData.supplierName : "Please select a supplier"}
              </Text>
            </HStack>
            {/* Transaction Date */}
            <HStack w="full">
        ...
        <VStack alignItems="start" w="full">
          ...
          <HStack w="full">
            ...
            <Input onChange={(e) => detailHandler(e.target.value)} value={details} w="full" bgColor="#fff8dc" />
          </HStack>
        </VStack>
            ...
            <Flex w="95%" justifyContent="space-between">
              ...
              <VStack alignItems="start" w="40%" mx={5}>
                ...
                <HStack w="full">
                  ...
                  <Text textAlign="center" bgColor="gray.200" w="full" border="1px" borderColor="gray.200" py={1.5}>
          ...
          <ModalFooter>
            <ButtonGroup size="xs">
              <Button
                ...
                disabled={!rawMatsInfo.itemCode || !rawMatsInfo.supplier || !rawMatsInfo.uom || !rawMatsInfo.expirationDate || !rawMatsInfo.quantity || !details}
                colorScheme="blue"
                px={4}
              >
                Add
