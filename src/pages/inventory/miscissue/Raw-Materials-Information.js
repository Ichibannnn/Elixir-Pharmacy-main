  ...
  return (
    <Flex justifyContent="center" flexDirection="column" w="full">
      <VStack w="full" spacing={6}>
        <Text bgColor="secondary" w="full" color="white" textAlign="center" fontWeight="semibold">
        ...
        <Flex w="95%" justifyContent="space-between">
          <VStack alignItems="start" w="40%" mx={5}>
            {/* Customer Code */}
            <HStack w="full">
              <Text minW="50%" w="auto" bgColor="secondary" color="white" pl={2} py={2.5} fontSize="xs">
                Customer:{" "}
              </Text>
              {customers.length > 0 ? (
                <Select onChange={(e) => customerHandler(e.target.value)} ref={customerRef} w="full" placeholder=" " bgColor="#fff8dc">
            ...
            <HStack w="full">
              ...
              {transactions.length > 0 ? (
                <Select onChange={(e) => setRemarks(e.target.value)} placeholder=" " bgColor="#fff8dc">
                  {transactions?.map((tt) => (
          ...
          <VStack alignItems="start" w="40%" mx={5}>
            ...
            <HStack w="full">
              ...
              <Text w="full" border="1px" borderColor="gray.200" py={1.5}>
                {rawMatsInfo.customer ? rawMatsInfo.customer : "Select a customer"}
              </Text>
            </HStack>
        ...
        <VStack alignItems="start" w="92%" mx={5}>
          {/* Details */}
          <HStack w="full">
            <Text w="auto" bgColor="secondary" color="white" pl={2} pr={5} py={2.5} fontSize="xs">
              Details:{" "}
            </Text>
            <Input onChange={(e) => detailHandler(e.target.value)} value={details} minW="93%" w="auto" bgColor="#fff8dc" />
          </HStack>
        </VStack>
        <Flex w="full" justifyContent="end" mt={4}>
          <Button onClick={() => openModal()} disabled={!rawMatsInfo.customer || !details || !remarks || !transactionDate} size="xs" colorScheme="blue">
            New
          </Button>
        </Flex>
      </VStack>
            ...
            <Flex w="95%" justifyContent="space-between">
              <VStack alignItems="start" w="40%" mx={5}>
                ...
                <HStack w="full">
                  ...
                  {expiryDates.length > 0 ? (
                    <Select onChange={(e) => expiryDateHandler(e.target.value)} w="full" placeholder=" " bgColor="#fff8dc">
              ...
              <VStack alignItems="start" w="40%" mx={5}>
                ...
                <HStack w="full">
                  ...
                  <Text textAlign="center" w="full" bgColor="gray.200" border="1px" borderColor="gray.200" py={1.5}>
                ...
                <HStack w="full">
                  ...
                  {expiryDates.length === 0 ? (
                    ...
                    <Text textAlign="center" w="full" bgColor="gray.200" border="1px" borderColor="gray.200" py={1.5}>
                      {availableStock ? availableStock : "Select an expiration date"}
                    </Text>
                  )}
                </HStack>
              </VStack>
