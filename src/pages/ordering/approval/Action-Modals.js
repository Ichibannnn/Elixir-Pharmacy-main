...
import { Button, ButtonGroup, Flex, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, Select, Text, useToast, VStack } from "@chakra-ui/react";
      ...
      <ModalContent>
        ...
        <ModalFooter>
          <ButtonGroup size="sm" mt={7}>
            <Button colorScheme="blue" onClick={submitHandler} isLoading={isLoading} disabled={isLoading}>
              Yes
            </Button>
            <Button colorScheme="red" onClick={onClose} isLoading={isLoading} disabled={isLoading}>
              No
            </Button>
          </ButtonGroup>
        </ModalFooter>
      ...
      <ModalContent>
        ...
        <ModalBody>
          <VStack justifyContent="center">
            ...
            {reasonData.length > 0 ? (
              <Select onChange={(e) => setReason(e.target.value)} placeholder="Please select a reason" bgColor="#fff8dc" w="60%">
        ...
        <ModalFooter>
          <ButtonGroup size="sm" mt={7}>
            <Button colorScheme="blue" disabled={!reason || isLoading} onClick={submitHandler} isLoading={isLoading}>
              Yes
            </Button>
            <Button colorScheme="red" isLoading={isLoading} disabled={isLoading}>
              No
            </Button>
          </ButtonGroup>
        </ModalFooter>
