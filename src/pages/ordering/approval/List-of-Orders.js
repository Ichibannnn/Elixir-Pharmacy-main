...
import { Button, ButtonGroup, Flex, HStack, Select, Table, Tbody, Td, Text, Th, Thead, Tr, useDisclosure } from "@chakra-ui/react";
  ...
  return (
    <Flex w="95%" p={10} flexDirection="column">
      ...
      <Flex justifyContent="end">
        <ButtonGroup size="xs">
          <Button colorScheme="blue" px={2} disabled={!orderNo} onClick={approveModal}>
            APPROVE
          </Button>
          <Button colorScheme="red" px={4} disabled={!orderNo} onClick={rejectModal}>
            REJECT
          </Button>
        </ButtonGroup>
      </Flex>
