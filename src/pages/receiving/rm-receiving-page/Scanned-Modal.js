...
const ScannedModal = ({ receivingId, itemCodeData, setReceivingDate, setLotCategory, setActualGood, quantity, remarks, sumQuantity, actualGood, lotCategory, receivingDate }) => {
  ...
  const { register } = useForm({
    ...
    defaultValues: {
      displayData: {
        id: itemCodeData.id,
        pO_Number: itemCodeData.ymir_PO_Number === null ? itemCodeData.pO_Number : itemCodeData.ymir_PO_Number,
        ...
        updatedStock: (parseInt(itemCodeData.totalStock) + parseInt(itemCodeData.actualDelivered)).toLocaleString(undefined, {
      ...
      <PageScrollReceiving>
        <Stack spacing={5}>
          ...
          <Flex justifyContent="space-between">
            ...
            <FormLabel w="40%">
              Expiration
              <Input {...register("displayData.expiration")} placeholder="Alapa Variable" readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
            </FormLabel>
          </Flex>
          ...
          <Flex justifyContent="space-between">
            ...
            <FormLabel w="40%">
              Days of Expiry
              <Input {...register("displayData.expirationDays")} placeholder="Alapa Variable" readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
            </FormLabel>
          </Flex>
          ...
          <Flex justifyContent="space-between">
            <FormLabel w="40%">
              Actual Delivery
              <Input {...register("displayData.expectedDelivery")} readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
            </FormLabel>

            <FormLabel w="40%">
              Qty. Good
              <Input placeholder="no data on get" {...register("displayData.actualDelivered")} readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
            </FormLabel>
          </Flex>
          ...
          <Flex justifyContent="space-between">
            <FormLabel w="40%">
              Total Stock
              <Input {...register("displayData.totalStock")} readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
            </FormLabel>

            <FormLabel w="40%">
              Updated Stock
              <Input {...register("displayData.updatedStock")} readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
            </FormLabel>
          </Flex>
          ...
          <Flex justifyContent="space-between">
            <FormLabel w="40%">
              Actual Reject
              <Input value={sumQuantity} readOnly={true} _disabled={{ color: "black" }} disabled={true} bgColor="gray.300" />
            </FormLabel>
          ...
          <ScannedModalRejection actualGood={actualGood} quantity={quantity} remarks={remarks} sumQuantity={sumQuantity} receivingId={receivingId} />
        </Stack>
      </PageScrollReceiving>
    </Flex>
  );
